...
public class CloudStorageProvider extends DocumentsProvider {
    ...
    private ArrayMap<Integer, CloudStorage> mRoots = new ArrayMap<>();
    ...
    public void updateConnections() {
        ...
        mRoots.clear();
        try {
            mCloudStorage = CloudStorageUtils.getService();
/*            cursor = getContext().getContentResolver().query(ExplorerProvider.buildStorage(), null, null, null, null);
            while (cursor.moveToNext()) {
                ...
                mRoots.put(id, mCloudStorage);
            }*/

            mRoots.put(47, mCloudStorage);
        } catch (Exception e) {
    ...
    public Cursor queryRoots(String[] projection) throws FileNotFoundException {
        ...
        synchronized (mRootsLock) {
            ...
            for (Map.Entry<Integer, CloudStorage> root : mRoots.entrySet()) {
                CloudStorage cloudStorage = root.getValue();
